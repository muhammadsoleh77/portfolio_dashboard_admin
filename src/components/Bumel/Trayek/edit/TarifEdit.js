...
export default class TarifEdit extends Component {
    ...
    render() {
        ...
        console.log(this.props.dataMaterial);
        console.log(this.props.dataTypeBus);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div className="row">
                                                    ...
                                                    {/* <select className="form-control" onChange={this.props.handleChangekotaAsal.bind(this)}>
                                                        <option disabled selected>Pilih Kota Asal</option>
                                                        {
                                                            dataLintasan.map((el, index) => {
                                                                return(
                                                                    <option key={index} value={index}>{el.namaLokasi}</option>
                                                                )
                                                            })
                                                        }
                                                    </select> */}
                                                    ...
                                                    <div className="col-md-5">
                                                        ...
                                                        /><br/>
                                                    {/* <select className="form-control" onChange={this.props.handleChangekotaAkhir.bind(this)}>
                                                    ...
                                                    <div className="col-md-2">
                                                        <button className="btn btn-dark" onClick={(e) => this.props.addTarif(e)}><i className="fa fa-plus"></i></button>
                                                    </div>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        {
                                                            this.props.arahTrayek.map((el, index) => {
                                                                ...
                                                                return(
                                                                    <tr>
                                                                        <td>{index + 1}</td>
                                                                        <td>{el.lokasiAwalNama}</td>
                                                                        <td>{el.lokasiAkhirNama}</td>
                                                                        <td>
                                                                            <input class="form-control" type="number" name="tarif" value={el.tarif} onChange={(e) => this.props.changeTarif(e, el)} />
                                                                        </td>
                                                                        <td>
                                                                            <input class="form-control" type="number" name="tarif" value={el.tarifMember} onChange={(e) => this.props.changeTarifMember(e, el)} />
                                                                        </td>
                                                                        <td>
                                                                            <input class="form-control" type="number" name="tarif" value={el.tarifNonTunai} onChange={(e) => this.props.changeTarifNonTunai(e, el)} />
                                                                        </td>
                                                                        <td>
                                                                            <Select
                                                                                name="typeBus"
