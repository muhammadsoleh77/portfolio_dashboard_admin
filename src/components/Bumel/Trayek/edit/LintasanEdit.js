...
export default class LintasanEdit extends Component {
                                                            ...
                                                            return(
                                                                <span>
                                                                    <i class="btn btn-city btn-xs">
                                                                        ...
                                                                        <input class="form-control" type="number" name="urutan" value={el.urutan} onChange={(e) => this.props.urutan(e.target, el)} placeholder="input urutan" />
                                                                    </i>
