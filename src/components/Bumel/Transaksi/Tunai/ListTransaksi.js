                                ...
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col-md-2">
                                                    <Select
                                                        ...
                                                        // value={this.state.dataPo.filter(option => option.idPo === this.props.idPo)}
                                                        // value={this.state.dataPo.find((val) => val.idPo === this.props.idPo)}
                                                    /><br />
                                                </div>
                                                <div className="col-md-2">
                                                    <DatePicker
                                                        ...
                                                        // selected={this.props.tglAwal ? this.props.tglAwal : this.state.startDate}
                                            ...
                                            <br /><p><strong>DATA TRANSAKSI TUNAI</strong></p>
                                            <div className="table-responsive">
                                                <table className="table table-bordered table-striped text-nowrap">
                                                    <thead>
                                                        <tr>
                                                        {/* <th rowspan="2" className="text-center" style={{ width: '1%', verticalAlign: 'middle' }}>Tanggal</th> */}
                                                    ...
                                                    <tbody>
                                                        {
                                                            this.props.dataTransaksi.map((el, index) => (
                                                                <tr>
                                                                    {/* <td className="text-center">{el.tanggal}</td> */}
