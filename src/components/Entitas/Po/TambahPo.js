...
export default class TambahPo extends Component {
    ...
    handleValidation(){
        ...
        if(!fields["kodepo"]){
            formIsValid = false;
            errors["kodepo"] = "Tidak boleh kosong";
        }
        ...
        if(!fields["bgColor"]){
            formIsValid = false;
            errors["bgColor"] = "Tidak boleh kosong";
        }

        // Validasi status
        if(!fields["enabled"]){
            formIsValid = false;
            errors["enabled"] = "Tidak boleh kosong";
        }

        // Validasi tanggal live
        if(!fields["startDate"]){
            formIsValid = false;
            errors["startDate"] = "Tidak boleh kosong";
        }

        // Validasi publikasi
        if(!fields["publish"]){
            formIsValid = false;
            errors["publish"] = "Tidak boleh kosong";
        }
        ...
        // Validasi setoran biaya lain
        if(!fields["tampilSetoranBiayaLain"]){
            formIsValid = false;
            errors["tampilSetoranBiayaLain"] = "Tidak boleh kosong";
        }
    ...
    tambahData(e){
        ...
        formData.append('bgColor', this.state.fields['bgColor']);
        formData.append('email', this.state.fields['email']);
        formData.append('startDate', this.state.fields['startDate']);
        formData.append('enabled', this.state.fields['enabled']);
        formData.append('fax', this.state.fields['fax']);
        formData.append('kodeBank', this.state.fields['kodeBank']);
        formData.append('kodepo', this.state.fields['kodepo']);
        ...
        formData.append('publish', this.state.fields['publish']);
        formData.append('tampilSetoranBiayaLain', this.state.fields['tampilSetoranBiayaLain']);
                        ...
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-left">
                                    ...
                                    <li className="breadcrumb-item active"><b>Tambah P.O</b></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Tambah P.O</h3>
                                    </div>
                                    <form onSubmit={this.tambahData.bind(this)}>
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input className="form-control" type="text" onChange={this.handleChange.bind(this, "kodepo")} />
                                                <span style={{ color: 'red' }}> {this.state.errors["kodepo"]} </span>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Telepon</label>
                                                <input className="form-control" type="text" onChange={this.handleChange.bind(this, "telpon")} />
                                            ...
                                            <div>
                                                ...
                                                <input className="form-control" type="text" onChange={this.handleChange.bind(this, "bgColor")} />
                                            ...
                                            {/* <div class="form-group">
                                                ...
                                                <div className="row">
                                                    <div className="col-3">
                                                        ...
                                                        onChange={this.handleChange.bind(this, "enabled")} /> <b>Ya</b>&nbsp;
                                                    </div>
                                                    <div className="col-3">
                                                        <input
                                                        type="radio"
                                                        ...
                                                        value="false"
                                                        // checked={isCashless === true}
                                                        onChange={this.handleChange.bind(this, "enabled")} /> <b>Tidak</b>&nbsp;
                                                    </div>
                                                </div>
                                                <span style={{ color: 'red' }}> {this.state.errors["enabled"]} </span>
                                            </div> */}
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input className="form-control" type="date" onChange={this.handleChange.bind(this, "startDate")} />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div className="row">
                                                    <div className="col-3">
                                                        ...
                                                        value="true"
                                                        // checked={isCashless === true}
                                                        onChange={this.handleChange.bind(this, "publish")} /> <b>Ya</b>&nbsp;
                                                    </div>
                                                    <div className="col-3">
                                                        <input
                                                        type="radio"
                                                        ...
                                                        value="false"
                                                        // checked={isCashless === true}
                                                        onChange={this.handleChange.bind(this, "publish")} /> <b>Tidak</b>&nbsp;
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div className="row">
                                                    <div className="col-3">
                                                        ...
                                                        value="true"
                                                        // checked={isCashless === true}
                                                        onChange={this.handleChange.bind(this, "tampilSetoranBiayaLain")} /> <b>Ya</b>&nbsp;
                                                    </div>
                                                    <div className="col-3">
                                                        <input
                                                        type="radio"
                                                        ...
                                                        value="false"
                                                        // checked={isCashless === true}
                                                        onChange={this.handleChange.bind(this, "tampilSetoranBiayaLain")} /> <b>Tidak</b>&nbsp;
                                                    </div>
                                                </div>
                                                <span style={{ color: 'red' }}> {this.state.errors["publish"]} </span>
                                            </div>
